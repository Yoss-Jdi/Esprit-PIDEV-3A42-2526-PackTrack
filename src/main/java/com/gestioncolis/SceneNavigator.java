...
import com.gestioncolis.controllers.addContoller;
import com.gestioncolis.controllers.addtechnicien;
import com.gestioncolis.controllers.chatbot;
import com.gestioncolis.controllers.displayContoller;
import com.gestioncolis.controllers.displaytechnicien;
import com.gestioncolis.controllers.modifyContoller;
import com.gestioncolis.controllers.modifytechnicien;
import com.gestioncolis.controllers.stat;
...
public class SceneNavigator {
    private static final String RESOURCE_BASE = "com/example/rayen/";
    ...
    public void showChatbotWindow() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(resource("chatbot.fxml"));
        loader.setControllerFactory(this::creerControleur);

        Parent root = loader.load();
        Scene scene = new Scene(root);
        scene.setFill(Color.TRANSPARENT);
        java.net.URL cssUrl = resource("style.css");
        if (cssUrl != null) {
    ...
    private void chargerVue(String nomFxml, String titreFenetre, Consumer<Object> configurationControleur) throws IOException {
        FXMLLoader loader = new FXMLLoader(resource(nomFxml));
        loader.setControllerFactory(this::creerControleur);
    ...
    private java.net.URL resource(String fileName) {
        return getClass().getClassLoader().getResource(RESOURCE_BASE + fileName);
    }
}
