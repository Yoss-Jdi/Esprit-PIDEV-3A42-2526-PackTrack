...
import com.gestioncolis.gui.SignaturePadDialog;
import com.gestioncolis.utils.CloudinaryConfig;
...
public class PdfService {
    ...
    private String loadTemplate() throws Exception {
        InputStream is = getClass().getResourceAsStream("/com/gestioncolis/templates/facture.html");
