...
public class DataSource {
    ...
    private DataSource() {
        ...
        URL = props.getProperty("db.url", "jdbc:mysql://localhost:3306/forum_fx?serverTimezone=UTC&useSSL=false&allowPublicKeyRetrieval=true");
    ...
    public long extractGeneratedId(PreparedStatement stmt) throws SQLException {
        try (ResultSet keys = stmt.getGeneratedKeys()) {
            ...
            throw new RuntimeException("Impossible de recuperer la cle generee.");
        }
    }
